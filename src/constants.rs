...
pub const SIGNAL_SPEED_IN_METRES_PER_S: f32         = 0.00015;
...
pub const COMMAND_CENTER_RADIUS_IN_METRES: f32 = 5.0;
...
pub fn convert_metres_to_pixels(value_in_metres: f32) -> u32 {
